    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-10 w-full max-w-md flex flex-col items-center gap-8">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <h1 className="text-2xl font-bold text-slate-800">Spectrum</h1>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 px-6 py-3.5 border-2 border-slate-200 rounded-xl hover:border-slate-300 hover:bg-slate-50 transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {loading ? (
        ...
        {/* Erro */}
        {error && (
          <p className="text-sm text-rose-600 text-center bg-rose-50 px-4 py-2 rounded-lg w-full">
            {error}
          </p>
        )}
